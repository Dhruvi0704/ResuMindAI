...
exports.SKILL_ONTOLOGY = void 0;
exports.normalizeText = normalizeText;
exports.extractRecognizedSkills = extractRecognizedSkills;
exports.SKILL_ONTOLOGY = {
    // AI & Machine Learning
...
function extractRecognizedSkills(text) {
    ...
    for (var _i = 0, _a = Object.entries(exports.SKILL_ONTOLOGY); _i < _a.length; _i++) {
        ...
        for (var _c = 0, aliases_1 = aliases; _c < aliases_1.length; _c++) {
            ...
            var regex = new RegExp("(?:^|\\s)(?:".concat(escapedAlias, ")(?:\\s|$)"), "i");
