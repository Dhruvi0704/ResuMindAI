  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4">
      <div className="text-center mb-8 max-w-xl">
        ...
        <h1 className="text-4xl font-bold text-blue-600 mb-4">Welcome to ResuMind AI</h1>
        <p className="text-muted-foreground text-lg leading-relaxed">
          Unlock the power of our comprehensive suite of tools designed to transform your job application process. We have everything you need to stand out in today's competitive job market.
        </p>
      </div>
      ...
      <Card className="w-full max-w-[500px] p-8 shadow-xl border-t-4 border-t-blue-600">
        ...
        <p className="text-center text-sm text-muted-foreground mt-8">
          ...
          <a onClick={() => setLocation("/signup")} className="text-blue-600 font-semibold cursor-pointer hover:underline">
            Sign Up
          </a>
        </p>
      </Card>
